 ...
 <div style="position:absolute;left: 170.06px;top: 550.77px;" class="cls_011"><span class="cls_011">Certificate no: 202101{{Auth::user()->id}}{{$evolution->course->id}}</span></div>
